...
To do so, I will perform a study for a broad range of readers to read and annotate political news stories (collected daily and sorted using a machine learning classifier) as supportive of a certain candidate. For each reader, I will collect their social media handles, demographic information, and self-reported political stances.
...
In this way, I will be able to capture clues that cause a story to be perceived as bias beyond the writing itself.
Hypotheses to be tested:
Is homophily between the reader's social network and the writer's predictive of perceived bias?
How do linguistic metrics (ie: computationally analyzed tone, sentiment, stance) of a story compare with social context in being perceived as biased?
